...
module.exports = {
    ...
    execute(message) { 
        ...
        const description = 'This bot is still in early development. Please report any bugs on [Github](https://github.com/cappig/MC-status-bot/issues)\n\n' +
                            ...
                            '\n[Invite to a server](https://discord.com/api/oauth2/authorize?client_id=816747912888975362&permissions=8&scope=bot) | [Privacy policy](https://github.com/cappig/MC-status-bot/blob/main/miscellaneous/Privacy_policy.md) | [Github](https://github.com/cappig/MC-status-bot)'
